...
contract Token is ERC20, Ownable {
    ...
    uint256 private _total = 2_0000_0000 ether;

    uint256 public _maxHold = _total;
    ...
    uint256 public txMarketFee = 1000;
    ...
    constructor() ERC20("Decentralized Privacy Storage Experiment", "DAS") {
        if (block.chainid == 56) {
    ...
    function _swap() private lockSwap {
        ...
        swapTokensForTokenB(swapTokens, address(_marketWallet));
